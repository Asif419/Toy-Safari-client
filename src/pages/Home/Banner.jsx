  ...
  return (
    <div className="hero min-h-[500px] bg-base-200 rounded-lg p-2 md:p-5">
      <div className="hero-content grid grid-cols-1 md:grid-cols-2 items-center">
        <div className="h-[250px] lg:h-[500px] carousel carousel-vertical px-10">
        ...
        <div className="">
          <h1 className="text-5xl font-bold font-black">Welcome to ToySafariWorld</h1>
          <p className="my-5">
          ...
          <div className='text-1xl text-black grid grid-cols-2'>
